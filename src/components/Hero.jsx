...
const Hero = () => {
  return (
    <section className="h-[80vh] xl:h-[850px] pb-12 pt-36" id="home">
      <div className="container mx-auto h-full flex justify-center items-center xl:justify-start">
        ...
        <div className="h-full flex flex-col justify-center items-center xl:items-start z-20 pt-12">
          <MouseParallaxContainer
            ...
            globalFactorY={0.2}
            resetOnLeave
            className="relative flex items-center h-[120px] xl:h-max xl:w-[710px]"
          >
            <MouseParallaxChild
              factorX={0.2}
              factorY={0.4}
            ...
            >
              <motion.div
                ...
                className="w-[300px] h-[101.37px] xl:w-[625px] xl:h-[234.97px]"
              >
                <Image
            ...
            >
              <motion.div
                ...
                whileInView={"show"}
                viewport={{ once: false, amount: 0.3 }}
                className="w-[300px] h-[101.37px] xl:w-[540px] xl:h-[224.97px]"
              >
                <Image
            ...
            >
              <motion.div
                ...
                whileInView={"show"}
                viewport={{ once: false, amount: 0.3 }}
                className="w-[50px] h-[80px] xl:w-[208px] xl:h-[200px] mix-blend-luminosity"
              >
                <Image
